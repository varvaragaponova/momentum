...
async function getDataFromAPI(url) {
  try {
    ...
    notificationBanner.textContent = translation[language === 'en' ? 'eng' : 'ru'].notificationBannerText;
...
async function setBg(event) {
  ...
  if (selectedImageAPI === 'git') {
    ...
    let url = `https://api.1unsplash.com/photos/random?client_id=QeEezdXf5jbb0onIJwCZLOykIigLacF63HjPlPEWdmw`;
